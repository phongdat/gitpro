...
global $US_Full_Version;
	...
	if (isset($_POST['aspect_ratio']) and $US_Full_Version == "Yes") {update_option('EWD_US_Aspect_Ratio', $_POST['aspect_ratio']);}
	...
	if (isset($_POST['add_watermark'])) {update_option('EWD_US_Add_Watermark', stripslashes_deep($_POST['add_watermark']));}
	if (isset($_POST['title_animate'])) {update_option('EWD_US_Title_Animate', stripslashes_deep($_POST['title_animate']));}
	if (isset($_POST['lightbox'])) {update_option('EWD_US_Lightbox', stripslashes_deep($_POST['lightbox']));}
