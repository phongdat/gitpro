...
function Add_EWD_US_FrontEnd_Scripts() {
    ...
    if ($Lightbox == "Yes") {
        wp_enqueue_script(  'lightgallery', plugins_url('ultimate-slider/js/lightgallery.js'), array('jquery'), true);
        wp_enqueue_script(  'jquery.mousewheel.min', plugins_url('ultimate-slider/js/jquery.mousewheel.min.js'), array('jquery', 'lightgallery'), true);
        wp_enqueue_script(  'lg-autoplay', plugins_url('ultimate-slider/js/lg-autoplay.js'), array('jquery', 'lightgallery'), true);
        wp_enqueue_script(  'lg-fullscreen', plugins_url('ultimate-slider/js/lg-fullscreen.js'), array('jquery', 'lightgallery'), true);
        wp_enqueue_script(  'lg-hash', plugins_url('ultimate-slider/js/lg-hash.js'), array('jquery', 'lightgallery'), true);
        wp_enqueue_script(  'lg-pager', plugins_url('ultimate-slider/js/lg-pager.js'), array('jquery', 'lightgallery'), true);
        wp_enqueue_script(  'lg-thumbnail', plugins_url('ultimate-slider/js/lg-thumbnail.js'), array('jquery', 'lightgallery'), true);
