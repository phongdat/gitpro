					...
					<tr>
						...
						<th scope="row">Add Watermark</th>
							<td>
								...
								<label title='Yes'><input type='radio' name='add_watermark' value='Yes' <?php if($Add_Watermark == "Yes") {echo "checked='checked'";} ?> /> <span>Yes</span></label><br />
								<label title='No'><input type='radio' name='add_watermark' value='No' <?php if($Add_Watermark == "No") {echo "checked='checked'";} ?> /> <span>No</span></label><br />
								<p>Should a watermark be added to each image? Requires GD to be set to yes on your server.</p>
								</fieldset>
							</td>
						</tr>
						...
						<th scope="row">Lightbox on Image Click</th>
							<td>
								...
								<label title='Yes'><input type='radio' name='lightbox' value='Yes' <?php if($Lightbox == "Yes") {echo "checked='checked'";} ?> /> <span>Yes</span></label><br />
								<label title='No'><input type='radio' name='lightbox' value='No' <?php if($Lightbox == "No") {echo "checked='checked'";} ?> /> <span>No</span></label><br />
			...
			<div id='Control' class='ewd-us-option-set ewd-us-hidden'>
				...
				<div id='us-styling-options' class="us-options-div us-options-flex">
					<div class='us-subsection'>
						...
						<div class='us-subsection-content'>
							<div class='us-option us-styling-option'>
								<div class='us-option-one-line'><input type='radio' name='us_arrow' value='None' <?php if ($us_Arrow == "None") {echo "checked='checked'";} ?> /> No Arrow</div><br />
								<div class='us-option-one-line'><input type='radio' name='us_arrow' value='a' <?php if ($us_Arrow == "a") {echo "checked='checked'";} ?>/> <span class='us-arrow'>b</span></div><br />
								<div class='us-option-one-line'><input type='radio' name='us_arrow' value='c' <?php if ($us_Arrow == "c") {echo "checked='checked'";} ?>/> <span class='us-arrow'>d</span></div><br />
								<div class='us-option-one-line'><input type='radio' name='us_arrow' value='e' <?php if ($us_Arrow == "e") {echo "checked='checked'";} ?>/> <span class='us-arrow'>f</span></div><br />
								<div class='us-option-one-line'><input type='radio' name='us_arrow' value='g' <?php if ($us_Arrow == "g") {echo "checked='checked'";} ?>/> <span class='us-arrow'>h</span></div><br />
								<div class='us-option-one-line'><input type='radio' name='us_arrow' value='i' <?php if ($us_Arrow == "i") {echo "checked='checked'";} ?>/> <span class='us-arrow'>j</span></div><br />
								<div class='us-option-one-line'><input type='radio' name='us_arrow' value='k' <?php if ($us_Arrow == "k") {echo "checked='checked'";} ?>/> <span class='us-arrow'>l</span></div><br />
								<div class='us-option-one-line'><input type='radio' name='us_arrow' value='m' <?php if ($us_Arrow == "m") {echo "checked='checked'";} ?>/> <span class='us-arrow'>n</span></div><br />
								<div class='us-option-one-line'><input type='radio' name='us_arrow' value='o' <?php if ($us_Arrow == "o") {echo "checked='checked'";} ?>/> <span class='us-arrow'>p</span></div><br />
								<div class='us-option-one-line'><input type='radio' name='us_arrow' value='q' <?php if ($us_Arrow == "q") {echo "checked='checked'";} ?>/> <span class='us-arrow'>r</span></div><br />
								<div class='us-option-one-line'><input type='radio' name='us_arrow' value='A' <?php if ($us_Arrow == "A") {echo "checked='checked'";} ?>/> <span class='us-arrow'>B</span></div><br />
								<div class='us-option-one-line'><input type='radio' name='us_arrow' value='E' <?php if ($us_Arrow == "E") {echo "checked='checked'";} ?>/> <span class='us-arrow'>F</span></div><br />
								<div class='us-option-one-line'><input type='radio' name='us_arrow' value='G' <?php if ($us_Arrow == "G") {echo "checked='checked'";} ?>/> <span class='us-arrow'>H</span></div><br />
								<div class='us-option-one-line'><input type='radio' name='us_arrow' value='I' <?php if ($us_Arrow == "I") {echo "checked='checked'";} ?>/> <span class='us-arrow'>J</span></div><br />
					...
					<div class='us-subsection'>
						...
						<div class='us-subsection-content'>
							<div class='us-option us-styling-option'>
								<div class='us-option-one-line'><input type='radio' name='us_arrow_background_shape' value='None' <?php if ($us_Arrow_Background_Shape == "None") {echo "checked=checked";} ?> /> No Background</div>
								<div class='us-option-one-line'><input type='radio' name='us_arrow_background_shape' value='Square' <?php if ($us_Arrow_Background_Shape == "Square") {echo "checked=checked";} ?> /> Square</div>
								<div class='us-option-one-line'><input type='radio' name='us_arrow_background_shape' value='Circle' <?php if ($us_Arrow_Background_Shape == "Circle") {echo "checked=checked";} ?> /> Circle</div>
								<div class='us-option-one-line'><input type='radio' name='us_arrow_background_shape' value='Diamond' <?php if ($us_Arrow_Background_Shape == "Diamond") {echo "checked=checked";} ?> /> Diamond</div>
							</div>
						</div>
					</div>
					<div class='us-subsection'>
